...
public final class TimeTableShardingAlgorithm implements SingleKeyTableShardingAlgorithm<Long> {
    private final int subPer = 3;

    private String getTableEnd(long value) {
        Calendar now = Calendar.getInstance();
        String tableEnd = (now.get(Calendar.MONTH) + 1) + "_" + value % subPer + "";
        return tableEnd;
    }
